...
@Mod("ncmllof")
public class NcmllofMod {
	public static final Logger LOGGER = LogManager.getLogger(NcmllofMod.class);
	public static final String MODID = "ncmllof";
